						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
								...
								<div class="card-body p-lg-17">
									<form action="./general/proses_ubah_siswa.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            <strong><label class="col-lg-4 col-form-label" for="val-username">NISN<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-email">NIS<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Name <span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
										...
										<div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Kelas <span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Address <span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Telephone Number<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
										...
										<a href="./general/siswa.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
									</form>
								</div>
                </div>
        </div>
