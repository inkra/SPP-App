			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Data Petugas</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
							...
							<div class="card">
                                ...
                                $no++;?>
                                        <tr class="text-xs font-weight-bold">
                                            ...
                                            <td class="align-middle text-left"><?=$data_petugas['id_petugas']?></td>
                                            <td class="align-middle text-left"><?=$data_petugas['username']?></td>
                                            <td class="align-middle text-left"><?=$data_petugas['password']?></td> 
                                            <td class="align-middle text-left"><?=$data_petugas['nama_petugas']?></td>
                                            <td class="align-middle text-left"><?=$data_petugas['level']?></td>  
                                            <td class="align-middle text-left">
                                            <a class="btn btn-success" href="./general/ubah_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" ><i class="far fa-edit"></i></a>
											<a href="./general/hapus_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                            </td>
                                        </tr>
                                        <?php
                                        }
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<form method="POST" action="./general/proses_tambah_petugas.php" enctype="multipart/form-data">
                          <section class="base">
                        <div class="mb-3">
