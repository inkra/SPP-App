				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Data Pembayaran- List Siswa</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
					...
					<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
                                ...
                                <a href="./general/pembayaran.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Kembali
                                </button></a> <br><br><br>
                                <?php 
											include "koneksi.php";
                                ...
                                <tbody>
                                    ...
                                    <td><a href="./general/pembayaran_siswa.php?nisn=<?php echo $data['nisn']?>" class="fs-5 text-gray-800 text-hover-primary fw-boldest"><button class="btn btn-primary px-5">Cari Data</button></a><br></td>
                                    </tr>
                                    <tr>
                                    <?php 
                                    } 
