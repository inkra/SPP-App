			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Data SPP</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
							...
							<div class="card">
                                ...
                                $no++;?>
                                        <tr class="text-xs font-weight-bold">
                                            ...
                                            <td class="align-middle text-left"><?=$data_spp['id_spp']?></td>
                                            <td class="align-middle text-left"><?=$data_spp['angkatan']?></td>
                                            <td class="align-middle text-left"><?=$data_spp['tahun']?></td> 
                                            <td class="align-middle text-left">Rp.<?=$data_spp['nominal']?></td>
                                            <td class="align-middle text-left">
                                            <a class="btn btn-success" href="./general/ubah_spp.php?id_spp=<?=$data_spp['id_spp']?>" ><i class="far fa-edit"></i></a>
											<a href="./general/hapus_spp.php?id_spp=<?=$data_spp['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                            </td>
                                        </tr>
                                        <?php
                                        }
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<form method="POST" action="./general/proses_tambah_spp.php" enctype="multipart/form-data">
                          <section class="base">
                        <div class="mb-3">
						...
						<br>
                        <div>
                            <input type="submit" name="simpan" value="Tambah Data SPP" class="btn btn-primary">
                        </div>
                      </section>
                      </form>
						</div>
