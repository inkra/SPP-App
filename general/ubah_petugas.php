				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<a class="menu-link py-3" href="../dist/index_admin.php">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Edit Data Petugas</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
					...
					<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
                                ...
                                <form action="./general/proses_ubah_petugas.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            <strong><label class="col-lg-4 col-form-label" for="val-username">Id Petugas<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-username" name="id_petugas" placeholder="Enter id petugas.." value="<?= $data['id_petugas']?>">
                                            </div>
                                        </div>
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-email">Username<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-email" name="username" placeholder="Enter Username.." value="<?= $data['username']?>">
                                            </div>
                                        </div>
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Password<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-password" name="password" placeholder="Enter the password..." value="<?= $data['password']?>">
                                            </div>
                                        </div>
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Nama Petugas<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Level<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-password" name="level" placeholder="Enter phone level.." value="<?=$data['level']?>">
                                            </div>
                                        </div>
                                        <br><br>
										...
										<a href="./general/petugas.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
									</form>
