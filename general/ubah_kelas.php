				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Edit Data Kelas</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
								...
								<div class="card-body p-lg-17">
									...
									<form action="./general/proses_ubah_kelas.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            <strong><label class="col-lg-4 col-form-label" for="val-username">Id Kelas<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-username" name="id_kelas" placeholder="Enter id kelas.." value="<?= $data['id_kelas']?>">
                                            </div>
                                        </div>
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-email">Nama Kelas<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-email" name="nama_kelas" placeholder="Enter nama kelas.." value="<?= $data['nama_kelas']?>">
                                            </div>
                                        </div>
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Jurusan<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-password" name="jurusan" placeholder="Enter the jurusan..." value="<?= $data['jurusan']?>">
                                            </div>
                                        </div>
                                        <div class="mb-3">
										<strong><label class="col-lg-4 col-form-label" for="val-password">Angkatan<span class="text-danger">*</span>
                                            </label></strong>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-password" name="angkatan" placeholder="Enter the angkatan..." value="<?= $data['angkatan']?>">
                                            </div>
                                        </div>
                                        <br><br>
										...
										<a href="./general/kelas.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
									</form>
								</div>
						</div>
