		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Data Kelas</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
                ...
                <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.min.js" integrity="sha384-j0CNLUeiqtyaRmlzUHCPZ+Gy5fQu0dQ6eZ/xAww941Ai1SxSY+0EQqNXNE6DZiVc" crossorigin="anonymous"></script>
						...
						<div class="col-14 col-lg-12 col-xxl-15 d-flex">
							<div class="card flex-fill">
                                ...
                                $no++;?>
                                        <tr class="text-xs font-weight-bold">
                                            ...
                                            <td class="align-middle text-left"><?=$data_kelas['id_kelas']?></td>
                                            <td class="align-middle text-left"><?=$data_kelas['nama_kelas']?></td>
                                            <td class="align-middle text-left"><?=$data_kelas['jurusan']?></td> 
                                            <td class="align-middle text-left"><?=$data_kelas['angkatan']?></td>
                                            <td class="align-middle text-left">
                                            <a class="btn btn-success" href="./general/ubah_kelas.php?id_kelas=<?=$data_kelas['id_kelas']?>" ><i class="far fa-edit"></i></a>
											<a href="./general/hapus_kelas.php?id_kelas=<?=$data_kelas['id_kelas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                            </td>
                                        </tr>
                                        <?php
                                        }
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<form method="POST" action="./general/proses_tambah_kelas.php" enctype="multipart/form-data">
                          <section class="base">
                        <div class="mb-3">
