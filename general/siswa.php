...
<html lang="en">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Data Siswa</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
 ...
 <div class="col-14 col-lg-12 col-xxl-14 d-flex">
     <div class="card flex-fill">
         <table class="table table-hover my-0">
             <thead>
                 <tr>
                     ...
                     <th class="d-none d-md-table-cell">No Telp</th>
         ...
         $no++;?>
                 <tr class="text-xs font-weight-bold">
                     ...
                     <td class="align-middle text-left"><?=$data_siswa['nisn']?></td>
                     <td class="align-middle text-left"><?=$data_siswa['nis']?></td>
                     <td class="align-middle text-left"><?=$data_siswa['nama']?></td> 
                     <td class="align-middle text-left"><?=$data_siswa['nama_kelas']?></td>
                     <td class="align-middle text-left"><?=$data_siswa['alamat']?></td>
                     <td class="align-middle text-left"><?=$data_siswa['no_tlp']?></td>   
                     <td class="align-middle text-left">
                     <a class="btn btn-success" href="./general/ubah_siswa.php?nisn=<?=$data_siswa['nisn']?>" ><i class="far fa-edit"></i></a>
                     <a href="./general/hapus_siswa.php?nisn=<?=$data_siswa['nisn']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                     </td>
                 </tr>
                 <?php
                 }
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<form method="POST" action="./general/proses_tambah_siswa.php" enctype="multipart/form-data">
                          <section class="base">
                        <div class="mb-3">
