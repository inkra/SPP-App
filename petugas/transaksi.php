				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Detail Pembayaran</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
									...
									<div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar" data-kt-sticky-offset="{default: false, xl: '80px'}" data-kt-sticky-width="{lg: '250px', xl: '325px'}" data-kt-sticky-left="auto" data-kt-sticky-top="90px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										...
										<div class="card-body pt-0 p-10">
											...
											<div class="d-flex flex-center flex-column mb-10">
												...
												<a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bolder mb-1"><?=$data_siswa['nama']?></a>
												<?php
												}
												?>
												<!--end::Name-->
								...
								<div class="flex-lg-row-fluid ms-lg-10">
									...
									<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
										...
										<tr>
											...
											<td></td>
											<td class="fw-bold fs-6"><?=$data_siswa['no_tlp']?></td>
										</tr>
										<?php
										}
										?>
     												...
     												<div class="card flex-fill">
														...
														<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
															...
															<div class="modal-content">
																...
																<form method="POST" action="./petugas/proses_tambah_transaksi.php" enctype="multipart/form-data">
																<section class="base">
																<div class="mb-3">
															...
															$no++;?>
																	<tr class="text-xs font-weight-bold">
																		...
																		<td>
																			<?php
																			if($data_pembayaran['tgl_bayar']=='0000-00-00'){
																				echo "<a class='btn btn-primary px-2' href='./petugas/proses_transaksi.php?id_pembayaran=$data_pembayaran[id_pembayaran]&nisn=$data_pembayaran[nisn]'>Bayar</a> ";
