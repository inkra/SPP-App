				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-center">
							...
							<div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
								<a href="../dist/petugas/index_petugas.php">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<a class="menu-link py-3" href="../dist/petugas/index_petugas.php">
											...
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													<div class="menu-item">
														<a class="menu-link py-3" href="../dist/petugas/list_kelas.php">
													...
													<div class="menu-item">
														<a class="menu-link py-3" href="../dist/petugas/histori.php">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
											...
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div class="menu-item">
														<a class="menu-link py-3" href="../dist/petugas/logout.php">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Data Transaksi - List Siswa</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
					...
					<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
                                ...
                                <a href="./petugas/list_kelas.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Kembali
                                </button></a> <br><br><br>
                                <?php 
											include "koneksi.php";
                                        ...
                                        ?>
                                <div class="col-14 col-lg-12 col-xxl-12 d-flex">
                                ...
                                <tbody>
                                    ...
                                    <td><a href="./petugas/transaksi.php?nisn=<?php echo $data['nisn']?>" class="fs-5 text-gray-800 text-hover-primary fw-boldest"><button class="btn btn-primary px-5">Cari Data</button></a><br></td>
                                    </tr>
                                    <tr>
                                    <?php 
                                    } 
                                ...
                                <br>
                                         <!--begin::Alert-->
											<div class="rounded border border-primary bg-light-primary border-dashed px-6 py-5">
												<a href="./general/pembayaran.php" class="link-primary fw-bolder fs-6 me-1">Data pembayaran SPP</a>
												<span class="text-gray-800 fw-bold fs-6"> siswa bedasarkan kelas . klik untuk melihat detail pembayaran setiap siswa.</span>
											</div>
											<!--end::Alert-->
										</div>
				</div>
