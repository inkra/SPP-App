				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Dashboard Petugas</h3>
							<!--begin::Title-->
						</div>
						<!--end::Container-->
					</div>
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
                                ...
                                <div class="jumbotron">
									...
									<p class="lead">Anda login menggunakan akun petugas.</p>
									<hr class="my-4">
									<p>Ini adalah halaman dashboard yang digunakan untuk sistem pembayaran SPP sekolah. Silahkan dikelola dengan baik!.</p>
									<a class="btn btn-primary btn-lg" href="./petugas/index_petugas.php" role="button">Learn more</a>
									</div>
										</div>
				</div>
